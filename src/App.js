...
const App = () => {
  ...
  const appConfig = {
    ...
    lancaDexRouterContracts: {
      ...
      'optimism': ['0xCF93E045778dE481De87586b91BC7C4F09147502'], // Ensured array
      'arbitrum': ['0xe6BbA380D02BF8a4c8185cA95025206B6f1Cf8C7'], // Ensured array
      // Corrected Avalanche router address and ensured it's an array
      'avalanche': ['0x4459d95b396c418B2144943910E2e68548fFE589'],
    },
